...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('keuangan.dashboard') }}">
                <i class="fas fa-graduation-cap me-2"></i>SPMB - Dashboard Keuangan
            </a>
            <div class="navbar-nav ms-auto">
                <span class="navbar-text text-white me-3">
                    <i class="fas fa-user-circle me-1"></i>{{ session('user')['name'] ?? 'Keuangan' }}
                </span>
